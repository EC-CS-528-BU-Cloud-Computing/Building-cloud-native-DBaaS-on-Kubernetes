...
func init() {
	...
	utilruntime.Must(tidbclusterv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "6f81ee50.dbaas",
	...
	if err = (&controllers.PdReconciler{
	...
	if err = (&controllers.TikvReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
