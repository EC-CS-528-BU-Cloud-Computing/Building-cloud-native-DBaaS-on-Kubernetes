...
//+kubebuilder:rbac:groups=dbaas.cs528,resources=pds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=dbaas.cs528,resources=pds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=dbaas.cs528,resources=pds/finalizers,verbs=update
...
func (r *PdReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	logger.Info("Pd reconcile")

	// TODO(user): your logic here
	instance := &dbaasv1alpha1.Pd{}
	...
	case dbaasv1alpha1.PhaseCreating:
		...
		if err != nil && errors.IsNotFound(err) {
			...
			logger.Info("TiDB pod failed", "reason", pdPod.Status.Reason, "message", pdPod.Status.Message)
			// delete failed pod
	...
	case dbaasv1alpha1.PhaseRunning:
		...
		if err != nil && errors.IsNotFound(err) {
			...
			// pod errored out, need to recreate
			logger.Info("Pd pod failed", "reason", pdPod.Status.Reason, "message", pdPod.Status.Message)
			// delete failed pod
			err = r.Delete(context.TODO(), pdPod)
			if err != nil {
				return ctrl.Result{}, err
...
func (r *PdReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&dbaasv1alpha1.Pd{}).
		Complete(r)
}

func (r *PdReconciler) UpdateInstanceStatus(ctx *context.Context, instance *dbaasv1alpha1.Pd) error {
