...
//+kubebuilder:rbac:groups=dbaas.cs528,resources=tidbs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=dbaas.cs528,resources=tidbs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=dbaas.cs528,resources=tidbs/finalizers,verbs=update
...
func (r *TidbReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&dbaasv1alpha1.Tidb{}).
		Complete(r)
}

// SetupWithManager sets up the controller with the Manager.
func (r *TidbReconciler) UpdateInstanceStatus(ctx *context.Context, instance *dbaasv1alpha1.Tidb) error {
